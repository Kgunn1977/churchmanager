...
CREATE TABLE `h_link_combination_rooms` (
  `combination_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  PRIMARY KEY (`combination_id`,`room_id`),
  KEY `room_id` (`room_id`),
  CONSTRAINT `h_link_combination_rooms_ibfk_1` FOREIGN KEY (`combination_id`) REFERENCES `h_link_combinations` (`id`) ON DELETE CASCADE,
  CONSTRAINT `h_link_combination_rooms_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '103');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '104');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '105');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '106');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '107');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '108');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('2', '109');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '111');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '112');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '113');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '114');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '115');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '116');
INSERT INTO `h_link_combination_rooms` (`combination_id`, `room_id`) VALUES ('3', '118');

DROP TABLE IF EXISTS `h_link_combinations`;
CREATE TABLE `h_link_combinations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL COMMENT 'Combo display name, e.g. Full Room',
  `virtual_room_id` int(11) DEFAULT NULL COMMENT 'Auto-created room representing this combo',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `group_id` (`group_id`),
  KEY `virtual_room_id` (`virtual_room_id`),
  CONSTRAINT `h_link_combinations_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `h_link_groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `h_link_combinations_ibfk_2` FOREIGN KEY (`virtual_room_id`) REFERENCES `rooms` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `h_link_combinations` (`id`, `group_id`, `name`, `virtual_room_id`, `created_at`) VALUES ('2', '2', 'Office Downstairs', '233', '2026-04-04 17:44:28');
INSERT INTO `h_link_combinations` (`id`, `group_id`, `name`, `virtual_room_id`, `created_at`) VALUES ('3', '3', 'Office Upstairs', '234', '2026-04-04 17:45:18');

DROP TABLE IF EXISTS `h_link_group_members`;
CREATE TABLE `h_link_group_members` (
  `group_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  PRIMARY KEY (`group_id`,`room_id`),
  KEY `room_id` (`room_id`),
  CONSTRAINT `h_link_group_members_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `h_link_groups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `h_link_group_members_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '103');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '104');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '105');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '106');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '107');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '108');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('2', '109');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '111');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '112');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '113');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '114');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '115');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '116');
INSERT INTO `h_link_group_members` (`group_id`, `room_id`) VALUES ('3', '118');

DROP TABLE IF EXISTS `h_link_groups`;
CREATE TABLE `h_link_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT 'Label for the group, e.g. Fellowship Hall',
  `floor_id` int(11) NOT NULL COMMENT 'All member rooms must be on this floor',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `floor_id` (`floor_id`),
  CONSTRAINT `h_link_groups_ibfk_1` FOREIGN KEY (`floor_id`) REFERENCES `floors` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `h_link_groups` (`id`, `name`, `floor_id`, `created_at`) VALUES ('2', 'Office Downstairs', '1', '2026-04-04 17:44:28');
INSERT INTO `h_link_groups` (`id`, `name`, `floor_id`, `created_at`) VALUES ('3', 'Office Upstairs', '2', '2026-04-04 17:45:18');
...
) ENGINE=InnoDB AUTO_INCREMENT=4714 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('13', '66', 'Sanctuary 1');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('13', '94', 'Sanctuary 2');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('13', '157', 'Balcony');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('14', '65', 'Gym 1');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('14', '92', 'Gym 2');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('15', '110', 'Lobby 1');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('15', '117', 'Lobby 2');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('16', '88', 'Children\'s Lobby 1');
INSERT INTO `room_link_members` (`link_id`, `room_id`, `original_name`) VALUES ('16', '102', 'Children\'s Lobby 2');
...
CREATE TABLE `room_links` (
  ...
  `building_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `virtual_room_id` int(11) DEFAULT NULL COMMENT 'Auto-created virtual room representing this V-Link group',
  PRIMARY KEY (`id`),
  KEY `idx_building` (`building_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `room_links` (`id`, `name`, `building_id`, `created_at`, `virtual_room_id`) VALUES ('13', 'Sanctuary', '1', '2026-04-04 17:42:59', '229');
INSERT INTO `room_links` (`id`, `name`, `building_id`, `created_at`, `virtual_room_id`) VALUES ('14', 'Gym', '1', '2026-04-04 17:43:07', '230');
INSERT INTO `room_links` (`id`, `name`, `building_id`, `created_at`, `virtual_room_id`) VALUES ('15', 'Lobby', '1', '2026-04-04 17:43:18', '231');
INSERT INTO `room_links` (`id`, `name`, `building_id`, `created_at`, `virtual_room_id`) VALUES ('16', 'Children\'s Lobby', '1', '2026-04-04 17:44:01', '232');
...
CREATE TABLE `rooms` (
  ...
  `is_virtual` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1 = auto-created virtual room for an H-Link combination',
  `h_link_combination_id` int(11) DEFAULT NULL COMMENT 'Points back to h_link_combinations.id for virtual rooms',
  PRIMARY KEY (`id`),
  KEY `floor_id` (`floor_id`),
  CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`floor_id`) REFERENCES `floors` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=235 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('2', '1', 'Gymnasium', NULL, NULL, NULL, NULL, NULL, '2026-03-25 20:44:45', '2026-03-25 20:44:45', NULL, '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('56', '1', 'Counseling Room', NULL, NULL, NULL, NULL, NULL, '2026-03-29 13:50:26', '2026-03-31 17:04:54', '[[0,106],[14,106],[14,120],[0,120]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('57', '1', 'Break Room', NULL, NULL, NULL, NULL, NULL, '2026-03-29 13:50:55', '2026-03-29 19:18:03', '[[14,106],[30,106],[30,120],[14,120]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('58', '1', 'CommOpps', NULL, NULL, NULL, NULL, NULL, '2026-03-29 13:51:44', '2026-03-31 17:04:54', '[[30,106],[44,106],[44,120],[30,120]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('59', '1', 'Men\'s South', NULL, NULL, NULL, NULL, NULL, '2026-03-29 13:53:18', '2026-03-31 17:04:54', '[[53,106],[62,106],[62,120],[53,120]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('60', '1', 'Women\'s South', 'WS', NULL, NULL, NULL, NULL, '2026-03-29 13:54:15', '2026-03-31 17:04:54', '[[44,106],[53,106],[53,120],[44,120]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('61', '1', 'Kitchen', 'Kit', NULL, NULL, NULL, NULL, '2026-03-29 13:55:12', '2026-03-29 19:18:03', '[[0,80],[40,80],[40,100],[0,100]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('62', '1', 'Coffee', 'C', NULL, NULL, NULL, NULL, '2026-03-29 13:56:20', '2026-03-29 19:18:03', '[[40,88],[49,88],[49,100],[40,100]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('64', '1', 'Electrical', 'Elec', NULL, NULL, NULL, NULL, '2026-03-29 15:03:45', '2026-03-31 17:04:54', '[[49,88],[62,88],[62,100],[49,100]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('65', '1', 'Gym', 'Gym', NULL, NULL, NULL, NULL, '2026-03-29 15:11:18', '2026-04-04 17:43:07', '[[0,0],[58,0],[58,39],[62,39],[62,45],[58,45],[58,80],[62,80],[62,88],[40,88],[40,80],[4,80],[4,48],[0,48],[0,29],[4,29],[4,11],[0,11]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('66', '1', 'Sanctuary', 'Sanc', NULL, NULL, NULL, NULL, '2026-03-29 15:13:06', '2026-04-04 17:42:59', '[[120,6],[120,0],[129,0],[129,4],[148,4],[148,60],[142,60],[142,60],[137,65],[140,68],[136,72],[133,69],[128,74],[128,80],[72,80],[72,73],[72,61],[68,61],[68,50],[74,50],[82,50],[82,43],[86,43],[113,16],[113,6]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('67', '1', 'Nursery', 'Nurs', NULL, NULL, NULL, NULL, '2026-03-29 15:43:58', '2026-03-29 19:18:03', '[[173,45],[173,20],[164,20],[164,14],[168,14],[168,0],[187,0],[187,80],[173,80],[162,69],[172,59],[167,54],[166,54],[166,45]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('68', '1', 'Women\'s Lounge Down', 'L', NULL, NULL, NULL, NULL, '2026-03-29 15:49:35', '2026-04-04 17:16:00', '[[154,6],[168,6],[168,14],[154,14]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('69', '1', 'Storage', 'S', NULL, NULL, NULL, NULL, '2026-03-29 15:50:38', '2026-03-31 18:51:41', '[[161,0],[168,0],[168,6],[161,6]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('70', '1', 'Janitorial', 'J', NULL, NULL, NULL, NULL, '2026-03-29 15:51:02', '2026-03-31 17:04:54', '[[161,0],[161,6],[154,6],[154,0]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('71', '1', 'Women\'s North', 'WN', NULL, NULL, NULL, NULL, '2026-03-29 15:52:09', '2026-03-31 17:04:54', '[[154,14],[164,14],[164,20],[167,20],[167,31],[154,31]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('72', '1', 'Men\'s North', 'MN', NULL, NULL, NULL, NULL, '2026-03-29 15:53:40', '2026-03-31 17:04:54', '[[154,38],[166,38],[166,54],[160,54],[154,54]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('73', '1', 'Nursery Restroom', 'N.R.', NULL, NULL, NULL, NULL, '2026-03-29 15:58:38', '2026-03-31 20:10:20', '[[167,20],[173,20],[173,29],[167,29]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('74', '1', 'Family Room', 'F.R.', NULL, NULL, NULL, NULL, '2026-03-29 17:10:07', '2026-03-29 19:18:03', '[[154,31],[167,31],[167,29],[173,29],[173,45],[166,45],[166,38],[154,38]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('75', '1', 'Elevator Machine Room', 'E.M.', NULL, NULL, NULL, NULL, '2026-03-29 17:14:29', '2026-03-31 17:04:54', '[[162,54],[167,54],[172,59],[166,65],[162,61]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('76', '1', 'Stair', NULL, NULL, NULL, NULL, NULL, '2026-03-29 17:18:28', '2026-04-04 17:39:37', '[[157,64],[162,69],[165,72],[162,75],[152,65],[153,64]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('77', '1', 'Elevator', 'Elev', NULL, NULL, NULL, NULL, '2026-03-29 17:27:36', '2026-03-31 17:04:54', '[[162,61],[166,65],[162,69],[158,65]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('78', '1', 'Stair', 'ST', NULL, NULL, NULL, NULL, '2026-03-29 17:30:52', '2026-04-04 17:39:37', '[[143,94],[140,97],[132,89],[132,85],[133,84]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('79', '1', 'Preschool Checkin', 'T.C.', NULL, NULL, NULL, NULL, '2026-03-29 17:34:08', '2026-03-31 20:13:00', '[[114,86],[122,86],[128,92],[128,100],[114,100]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('80', '1', 'Preschool Restroom', 'RR', NULL, NULL, NULL, NULL, '2026-03-29 17:37:11', '2026-03-31 20:13:00', '[[108,86],[114,86],[114,100],[108,100]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('81', '1', 'Prayer Room West', 'PR.W.', NULL, NULL, NULL, NULL, '2026-03-29 17:39:48', '2026-03-29 19:18:03', '[[68,86],[80,86],[80,100],[68,100]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('82', '1', 'Prayer Room East', 'PR.E.', NULL, NULL, NULL, NULL, '2026-03-29 17:40:51', '2026-03-29 19:18:03', '[[68,106],[80,106],[80,120],[68,120]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('83', '1', 'Preschool West', 'T.W.', NULL, NULL, NULL, NULL, '2026-03-29 17:42:14', '2026-03-31 20:13:00', '[[80,86],[108,86],[108,100],[80,100]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('84', '1', 'Preschool East', 'T.E.', NULL, NULL, NULL, NULL, '2026-03-29 17:42:35', '2026-03-31 20:13:00', '[[80,106],[108,106],[108,120],[80,120]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('85', '1', 'Preschool Main', 'T.M.', NULL, NULL, NULL, NULL, '2026-03-29 17:43:18', '2026-03-31 20:13:00', '[[108,100],[137,100],[147,110],[147,120],[108,120],[108,106],[80,106],[80,100]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('86', '1', 'Vestibule', 'V', NULL, NULL, NULL, NULL, '2026-03-29 17:45:43', '2026-03-31 17:04:54', '[[157,120],[147,120],[147,112],[157,112]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('87', '1', 'Vestibule', 'V', NULL, NULL, NULL, NULL, '2026-03-29 17:54:53', '2026-03-31 17:04:54', '[[179,80],[187,80],[187,90],[179,90]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('88', '1', 'Children\'s Lobby', 'C.L.', NULL, NULL, NULL, NULL, '2026-03-29 17:55:39', '2026-04-04 17:44:01', '[[146,71],[149,74],[155,68],[162,75],[165,72],[173,80],[179,80],[179,90],[178,90],[157,111],[157,112],[147,112],[147,110],[137,100],[128,100],[128,92],[122,86],[132,86],[132,89],[140,97],[143,94],[136,87],[142,81],[139,78]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('89', '1', 'Corridor B', 'C-B', NULL, NULL, NULL, NULL, '2026-03-29 17:58:38', '2026-03-31 17:04:54', '[[0,100],[80,100],[80,106],[68,106],[68,120],[62,120],[62,106],[0,106]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('90', '1', 'Corridor A', 'C-A', NULL, NULL, NULL, NULL, '2026-03-29 18:00:14', '2026-03-31 17:04:54', '[[62,0],[68,0],[68,100],[62,100],[62,57],[58,57],[58,45],[62,45],[62,39],[62,19],[58,19],[58,19],[58,0]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('91', '1', 'Corridor C', 'C-C', NULL, NULL, NULL, NULL, '2026-03-29 18:00:49', '2026-03-31 17:04:54', '[[68,80],[128,80],[148,60],[148,0],[154,0],[154,54],[162,54],[162,61],[158,65],[157,64],[153,64],[132,85],[132,86],[68,86]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('92', '2', 'Gym', 'Gym', NULL, NULL, NULL, NULL, '2026-03-29 19:19:26', '2026-04-04 17:43:07', '[[0,0],[58,0],[58,80],[0,80]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('93', '1', 'Green Room', 'GR', NULL, NULL, NULL, NULL, '2026-03-29 19:27:34', '2026-03-31 11:25:53', '[[68,0],[110,0],[110,6],[98,6],[74,30],[74,50],[68,50]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('94', '2', 'Sanctuary', 'Sanc', NULL, NULL, NULL, NULL, '2026-03-30 07:58:51', '2026-04-04 17:42:59', '[[74,30],[98,6],[120,6],[120,0],[129,0],[129,4],[135,4],[135,37],[105,66],[72,66],[72,61],[68,61],[68,50],[74,50]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('98', '2', 'Stair 2 (copy)', 'S2(', NULL, NULL, NULL, NULL, '2026-03-31 08:33:37', '2026-04-04 17:39:37', '[[139,78],[142,81],[136,87],[143,94],[140,97],[132,89],[132,85]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('99', '2', 'Stair 3', 'S3', NULL, NULL, NULL, NULL, '2026-03-31 08:34:03', '2026-03-31 17:05:50', '[[153,64],[157,64],[162,69],[165,72],[162,75],[155,68],[149,74],[146,71]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('100', '2', 'Elevator', 'ELEV', NULL, NULL, NULL, NULL, '2026-03-31 08:35:10', '2026-03-31 17:05:50', '[[162,61],[166,65],[162,69],[158,65]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('102', '2', 'Children\'s Lobby', 'C.L.', NULL, NULL, NULL, NULL, '2026-03-31 08:37:05', '2026-04-04 17:44:01', '[[146,71],[149,74],[155,68],[162,75],[165,72],[173,80],[179,80],[179,90],[178,90],[157,111],[157,112],[147,112],[147,110],[137,100],[128,100],[128,93],[132,89],[140,97],[143,94],[136,87],[142,81],[139,78]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('103', '1', 'Office Corridor Down', 'OCD', NULL, NULL, NULL, NULL, '2026-03-31 09:08:44', '2026-03-31 17:04:54', '[[75,-8],[139,-8],[139,0],[75,0]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('104', '1', 'Office 105', 'O-105', NULL, NULL, NULL, NULL, '2026-03-31 09:10:42', '2026-03-31 17:04:54', '[[123,-17],[139,-17],[139,-8],[123,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('105', '1', 'Office 104', 'O-104', NULL, NULL, NULL, NULL, '2026-03-31 09:12:00', '2026-03-31 17:04:54', '[[113,-17],[123,-17],[123,-8],[113,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('106', '1', 'Office 103', 'O-103', NULL, NULL, NULL, NULL, '2026-03-31 09:14:34', '2026-03-31 17:04:54', '[[103,-17],[113,-17],[113,-8],[103,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('107', '1', 'Office 102', 'O-102', NULL, NULL, NULL, NULL, '2026-03-31 09:15:07', '2026-03-31 17:04:54', '[[93,-17],[103,-17],[103,-8],[93,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('108', '1', 'Office 101', 'O-101', NULL, NULL, NULL, NULL, '2026-03-31 09:15:29', '2026-03-31 17:04:54', '[[83,-17],[93,-17],[93,-8],[83,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('109', '1', 'Reception', 'Rec', NULL, NULL, NULL, NULL, '2026-03-31 09:15:49', '2026-03-31 17:04:54', '[[71,-17],[83,-17],[83,-8],[71,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('110', '1', 'Lobby', 'L', NULL, NULL, NULL, NULL, '2026-03-31 09:18:20', '2026-04-04 17:43:18', '[[30,-17],[71,-17],[71,-8],[75,-8],[75,0],[30,0]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('111', '2', 'Office 2-1', 'O21', NULL, NULL, NULL, NULL, '2026-03-31 09:24:31', '2026-03-31 17:05:50', '[[71,-17],[83,-17],[83,-8],[71,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('112', '2', 'Office 2-2', 'O22', NULL, NULL, NULL, NULL, '2026-03-31 09:26:34', '2026-03-31 17:05:50', '[[83,-17],[93,-17],[93,-8],[83,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('113', '2', 'Office 1-3', 'O23', NULL, NULL, NULL, NULL, '2026-03-31 09:27:06', '2026-03-31 17:05:50', '[[93,-17],[103,-17],[103,-8],[93,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('114', '2', 'Office 2-4', 'O24', NULL, NULL, NULL, NULL, '2026-03-31 09:27:32', '2026-03-31 17:05:50', '[[103,-17],[113,-17],[113,-8],[103,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('115', '2', 'Office 2-5', 'O25', NULL, NULL, NULL, NULL, '2026-03-31 09:27:55', '2026-03-31 17:05:50', '[[113,-17],[127,-17],[127,-8],[113,-8]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('116', '2', 'Conference Room', 'CR', NULL, NULL, NULL, NULL, '2026-03-31 09:30:09', '2026-03-31 10:43:14', '[[127,-17],[160,-17],[160,-4],[127,-4]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('117', '2', 'Lobby', 'L', NULL, NULL, NULL, NULL, '2026-03-31 09:30:58', '2026-04-04 17:43:18', '[[30,-17],[71,-17],[71,-8],[75,-8],[75,0],[30,0]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('118', '2', 'Office Corridor U', 'OCU', NULL, NULL, NULL, NULL, '2026-03-31 09:32:08', '2026-03-31 17:05:50', '[[75,-8],[127,-8],[127,-4],[151,-4],[151,0],[75,0]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('119', '2', 'Fireside Room', 'F.R.', NULL, NULL, NULL, NULL, '2026-03-31 09:48:40', '2026-03-31 16:54:07', '[[0,80],[43,80],[43,86],[68,86],[68,97],[43,97],[43,111],[0,111]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('120', '2', 'Storage 28', 'S28', NULL, NULL, NULL, NULL, '2026-03-31 09:50:26', '2026-03-31 18:50:56', '[[0,111],[68,111],[68,120],[0,120]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('121', '2', 'Pantry', 'P', NULL, NULL, NULL, NULL, '2026-03-31 09:53:11', '2026-03-31 17:05:50', '[[62,97],[68,97],[68,111],[62,111]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('122', '2', 'Fireside Cafe', 'F.C.', NULL, NULL, NULL, NULL, '2026-03-31 09:55:51', '2026-03-31 09:56:04', '[[43,97],[62,97],[62,111],[43,111]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('123', '2', '204', '204', NULL, NULL, NULL, NULL, '2026-03-31 10:02:00', '2026-03-31 10:12:02', '[[68,93],[88,93],[88,111],[68,111]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('125', '2', '203', '203', NULL, NULL, NULL, NULL, '2026-03-31 10:11:48', '2026-03-31 10:12:06', '[[88,93],[108,93],[108,111],[88,111]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('126', '2', 'Men\'s Shower 1', 'MS1', NULL, NULL, NULL, NULL, '2026-03-31 10:16:31', '2026-03-31 17:05:50', '[[108,100],[115,100],[115,111],[108,111]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('127', '2', 'Men\'s Shower 2', 'MS2', NULL, NULL, NULL, NULL, '2026-03-31 10:17:00', '2026-03-31 17:05:50', '[[115,100],[122,100],[122,111],[115,111]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('128', '2', 'Men\'s Up', 'MU', NULL, NULL, NULL, NULL, '2026-03-31 10:18:26', '2026-03-31 17:05:50', '[[108,93],[128,93],[128,100],[137,100],[143,106],[143,111],[128,111],[128,104],[122,104],[122,100],[108,100]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('129', '2', 'Janitor Closet 3', 'JC3', NULL, NULL, NULL, NULL, '2026-03-31 10:20:53', '2026-03-31 17:05:50', '[[122,104],[128,104],[128,111],[122,111]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('130', '2', 'Storage 27', NULL, NULL, NULL, NULL, NULL, '2026-03-31 10:22:40', '2026-03-31 18:50:56', '[[68,111],[143,111],[143,106],[147,110],[147,120],[68,120]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('131', '2', '201', '201', NULL, NULL, NULL, NULL, '2026-03-31 10:24:29', '2026-03-31 10:25:26', '[[160,0],[178,0],[178,18],[160,18]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('132', '2', '202', '202', NULL, NULL, NULL, NULL, '2026-03-31 10:25:38', '2026-03-31 10:25:54', '[[160,18],[178,18],[178,36],[160,36]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('133', '2', 'Women\'s Shower 1', 'WS1', NULL, NULL, NULL, NULL, '2026-03-31 10:29:08', '2026-03-31 17:05:50', '[[172,36],[178,36],[178,46],[172,46]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('134', '2', 'Women\'s Shower 2', 'WS2', NULL, NULL, NULL, NULL, '2026-03-31 10:29:59', '2026-03-31 17:05:50', '[[172,46],[178,46],[178,56],[172,56]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('135', '2', 'Women\'s Up', 'WU', NULL, NULL, NULL, NULL, '2026-03-31 10:31:24', '2026-03-31 17:05:50', '[[167,56],[178,56],[178,80],[173,80],[162,69],[166,65],[162,61]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('136', '2', 'Women\'s Lounge Up', 'WLU', NULL, NULL, NULL, NULL, '2026-03-31 10:32:52', '2026-03-31 17:05:50', '[[160,36],[172,36],[172,50],[160,50]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('138', '2', 'Storage 26', 'S26', NULL, NULL, NULL, NULL, '2026-03-31 10:35:00', '2026-03-31 18:50:56', '[[178,0],[188,0],[188,80],[178,80]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('139', '2', 'Storage 25', 'S25', NULL, NULL, NULL, NULL, '2026-03-31 10:37:26', '2026-03-31 18:50:56', '[[148,54],[154,54],[148,60],[145,57]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('140', '2', 'Roof Access', 'RA', NULL, NULL, NULL, NULL, '2026-03-31 10:38:51', '2026-03-31 17:05:50', '[[141,61],[145,57],[148,60],[144,64]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('141', '2', 'Storage 23', 'S23', NULL, NULL, NULL, NULL, '2026-03-31 10:39:24', '2026-03-31 18:50:56', '[[68,0],[120,0],[120,6],[98,6],[74,30],[68,30]]', '1', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('142', '2', 'Electrical 2', 'E2', NULL, NULL, NULL, NULL, '2026-03-31 10:41:33', '2026-03-31 17:05:50', '[[68,30],[74,30],[74,50],[68,50]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('143', '2', 'Workshop', 'WS', NULL, NULL, NULL, NULL, '2026-03-31 10:42:43', '2026-03-31 17:05:50', '[[43,80],[62,80],[62,86],[43,86]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('144', '2', 'Stair 1', 'ST1', NULL, NULL, NULL, NULL, '2026-03-31 10:44:30', '2026-03-31 17:05:50', '[[62,57],[62,80],[58,80],[58,57]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('145', '1', 'Stair 1', 'S1', NULL, NULL, NULL, NULL, '2026-03-31 10:44:55', '2026-03-31 17:04:54', '[[62,57],[62,74],[58,74],[58,57]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('146', '1', 'Storage 24', 'S24', NULL, NULL, NULL, NULL, '2026-03-31 10:51:47', '2026-03-31 18:51:41', '[[58,19],[62,19],[62,39],[58,39]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('147', '1', 'Storage G1', 'SG1', NULL, NULL, NULL, NULL, '2026-03-31 10:55:28', '2026-03-31 18:51:41', '[[0,11],[4,11],[4,19],[0,19]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('148', '1', 'Storage G2', 'SG2', NULL, NULL, NULL, NULL, '2026-03-31 10:56:01', '2026-03-31 18:51:41', '[[0,19],[4,19],[4,29],[0,29]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('149', '1', 'Storage Gym 3', 'SG3', NULL, NULL, NULL, NULL, '2026-03-31 10:56:33', '2026-03-31 18:51:41', '[[0,48],[4,48],[4,59],[0,59]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('150', '1', 'Storage Gym 4', 'SG4', NULL, NULL, NULL, NULL, '2026-03-31 10:57:09', '2026-03-31 17:04:54', '[[0,59],[4,59],[4,80],[0,80]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('151', '1', 'Storage Gym 5', 'SG5', NULL, NULL, NULL, NULL, '2026-03-31 10:57:56', '2026-03-31 18:51:41', '[[58,74],[62,74],[62,80],[58,80]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('152', '1', 'Elevator 2', 'E2', NULL, NULL, NULL, NULL, '2026-03-31 10:59:23', '2026-03-31 18:51:41', '[[110,0],[120,0],[120,6],[110,6]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('153', '1', 'Video Room', 'VR', NULL, NULL, NULL, NULL, '2026-03-31 11:01:26', '2026-03-31 17:04:54', '[[148,60],[140,68],[137,65],[142,60]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('154', '1', 'Tech', 'T', NULL, NULL, NULL, NULL, '2026-03-31 11:01:56', '2026-03-31 18:51:41', '[[128,74],[133,69],[136,72],[128,80]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('155', '2', 'Stair 4', 'ST4', NULL, NULL, NULL, NULL, '2026-03-31 11:04:32', '2026-03-31 17:05:50', '[[129,0],[148,0],[148,4],[129,4]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('156', '2', 'Stair 5', 'ST5', NULL, NULL, NULL, NULL, '2026-03-31 11:05:39', '2026-03-31 17:05:50', '[[68,61],[72,61],[72,81],[68,81]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('157', '2', 'Sanctuary', 'B', NULL, NULL, NULL, NULL, '2026-03-31 11:07:29', '2026-04-04 17:42:59', '[[105,66],[108,63],[112,67],[136,44],[132,40],[135,37],[135,4],[148,4],[148,0],[154,0],[154,54],[148,54],[141,61],[144,64],[122,86],[68,86],[68,81],[72,81],[72,66]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('158', '2', 'Sound Booth', 'SB', NULL, NULL, NULL, NULL, '2026-03-31 11:09:06', '2026-03-31 11:09:21', '[[108,63],[132,40],[136,44],[112,67]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('162', '1', 'Stair 5 (copy)', 'S5', NULL, NULL, NULL, NULL, '2026-03-31 11:13:39', '2026-04-04 17:39:37', '[[68,61],[72,61],[72,73],[68,73]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('163', '1', 'Stair 4 (copy)', 'S4(', NULL, NULL, NULL, NULL, '2026-03-31 11:14:30', '2026-03-31 17:04:54', '[[129,0],[141,0],[141,4],[129,4]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('164', '1', 'Janitorial 5', 'J5', NULL, NULL, NULL, NULL, '2026-03-31 11:15:25', '2026-03-31 17:04:54', '[[141,0],[148,0],[148,4],[141,4]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('165', '1', 'Storage 6', 'S6', NULL, NULL, NULL, NULL, '2026-03-31 11:15:47', '2026-03-31 18:51:41', '[[68,73],[72,73],[72,80],[68,80]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('166', '1', 'Hospitality 1', 'H1', NULL, NULL, NULL, NULL, '2026-03-31 11:17:58', '2026-03-31 18:51:41', '[[152,65],[155,68],[149,74],[146,71]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('167', '1', 'Hospitality 2', 'H2', NULL, NULL, NULL, NULL, '2026-03-31 11:18:42', '2026-03-31 18:51:41', '[[139,78],[142,81],[136,87],[133,84]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('168', '1', 'Stage', 'Sg', NULL, NULL, NULL, NULL, '2026-03-31 11:23:57', '2026-03-31 11:25:48', '[[98,6],[113,6],[113,16],[86,43],[74,43],[74,30]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('169', '1', 'Baptistery', 'B', NULL, NULL, NULL, NULL, '2026-03-31 11:24:39', '2026-03-31 11:24:47', '[[74,43],[82,43],[82,50],[74,50]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('170', '7', 'Chapel', 'Ch', NULL, NULL, NULL, NULL, '2026-03-31 11:29:42', '2026-04-03 12:33:56', '[[12,50],[51,50],[51,106],[12,106]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('174', '7', 'Storage Chair', 'S.C.', NULL, NULL, NULL, NULL, '2026-03-31 11:37:46', '2026-03-31 18:52:10', '[[12,106],[24,106],[24,121],[16,121],[16,116],[12,116]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('176', '7', 'Lounge', 'L', NULL, NULL, NULL, NULL, '2026-03-31 11:39:07', '2026-03-31 12:10:18', '[[24,106],[51,106],[51,121],[24,121]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('177', '7', 'Fellowship', 'F', NULL, NULL, NULL, NULL, '2026-03-31 11:40:06', '2026-03-31 12:10:36', '[[51,41],[79,41],[79,66],[90,66],[90,70],[74,70],[74,90],[77,90],[77,106],[74,106],[74,121],[51,121]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('178', '7', 'Storage 1', NULL, NULL, NULL, NULL, NULL, '2026-03-31 11:41:08', '2026-03-31 18:52:10', '[[16,30],[16,26],[51,26],[51,38],[12,38],[12,30]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('179', '7', '100', '100', NULL, NULL, NULL, NULL, '2026-03-31 11:42:32', '2026-03-31 12:09:53', '[[74,106],[90,106],[90,121],[74,121]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('180', '7', 'Men\'s East', 'M.E.', NULL, NULL, NULL, NULL, '2026-03-31 11:44:35', '2026-03-31 17:06:15', '[[77,98],[90,98],[90,106],[77,106]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('181', '7', 'Women\'s East', 'W.E.', NULL, NULL, NULL, NULL, '2026-03-31 11:44:59', '2026-03-31 17:06:15', '[[77,90],[90,90],[90,98],[77,98]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('182', '7', 'Kitchen', 'K', NULL, NULL, NULL, NULL, '2026-03-31 11:46:31', '2026-03-31 12:09:43', '[[74,70],[90,70],[90,90],[74,90]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('183', '7', 'Mech 10', 'M-10', NULL, NULL, NULL, NULL, '2026-03-31 11:48:23', '2026-03-31 17:06:15', '[[79,59],[90,59],[90,66],[79,66]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('184', '7', 'Storage 10', 'S-10', NULL, NULL, NULL, NULL, '2026-03-31 11:49:01', '2026-03-31 18:52:10', '[[79,41],[90,41],[90,59],[79,59]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('185', '7', '101', '101', NULL, NULL, NULL, NULL, '2026-03-31 11:50:10', '2026-03-31 12:09:32', '[[65,26],[90,26],[90,41],[65,41]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('186', '7', 'Storage 11', 'S-11', NULL, NULL, NULL, NULL, '2026-03-31 11:51:36', '2026-03-31 18:52:10', '[[61,31],[65,31],[65,41],[61,41]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('187', '7', 'Stair 1', 'St1', NULL, NULL, NULL, NULL, '2026-03-31 11:52:28', '2026-03-31 17:06:15', '[[51,31],[55,31],[55,41],[51,41]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('188', '7', 'Janitorial 1', 'J-1', NULL, NULL, NULL, NULL, '2026-03-31 11:54:13', '2026-03-31 17:06:15', '[[61,26],[65,26],[65,31],[61,31]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('189', '7', 'Corridor A', 'C-A', NULL, NULL, NULL, NULL, '2026-03-31 11:54:54', '2026-04-03 12:32:08', '[[0,18],[72,18],[72,14],[90,14],[90,26],[61,26],[61,41],[55,41],[55,26],[46,26],[46,22],[40,22],[40,26],[29,26],[29,22],[10,22],[10,26],[0,26]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('190', '7', 'Janitorial 2', 'J2', NULL, NULL, NULL, NULL, '2026-03-31 11:55:44', '2026-03-31 17:06:15', '[[51,26],[55,26],[55,31],[51,31]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('191', '7', 'Women\'s West', 'W.W.', NULL, NULL, NULL, NULL, '2026-03-31 11:58:01', '2026-03-31 17:06:15', '[[81,0],[90,0],[90,14],[81,14]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('192', '7', 'Men\'s West', 'MW', NULL, NULL, NULL, NULL, '2026-03-31 11:58:53', '2026-03-31 17:06:15', '[[72,0],[81,0],[81,14],[72,14]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('193', '7', '102', '102', NULL, NULL, NULL, NULL, '2026-03-31 12:00:54', '2026-03-31 12:09:22', '[[43,0],[72,0],[72,18],[43,18]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('194', '7', '103', '103', NULL, NULL, NULL, NULL, '2026-03-31 12:01:47', '2026-03-31 12:09:16', '[[14,0],[43,0],[43,18],[14,18]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('195', '7', 'Office', 'Off', NULL, NULL, NULL, NULL, '2026-03-31 12:04:42', '2026-03-31 12:09:14', '[[0,0],[14,0],[14,18],[0,18]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('196', '7', 'Mech 0', NULL, NULL, NULL, NULL, NULL, '2026-03-31 12:14:55', '2026-03-31 17:06:15', '[[12,116],[16,116],[16,121],[12,121]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('197', '7', 'Electrical 2', 'E2', NULL, NULL, NULL, NULL, '2026-03-31 12:15:38', '2026-03-31 17:06:15', '[[12,26],[16,26],[16,30],[12,30]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('198', '7', 'Stair 2', 'ST-2', NULL, NULL, NULL, NULL, '2026-03-31 12:18:40', '2026-03-31 17:06:15', '[[10,22],[22,22],[22,26],[10,26]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('199', '7', 'Mech 11', 'M-11', NULL, NULL, NULL, NULL, '2026-03-31 12:19:12', '2026-03-31 17:06:15', '[[40,22],[46,22],[46,26],[40,26]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('200', '7', 'Storage 12', 'S-12', NULL, NULL, NULL, NULL, '2026-03-31 12:19:52', '2026-03-31 18:52:10', '[[22,22],[29,22],[29,26],[22,26]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('202', '8', '204', '204', NULL, NULL, NULL, NULL, '2026-03-31 12:24:29', '2026-03-31 12:32:49', '[[26,0],[42,0],[42,17],[26,17]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('203', '8', '203', '203', NULL, NULL, NULL, NULL, '2026-03-31 12:24:53', '2026-03-31 12:32:49', '[[42,0],[58,0],[58,17],[42,17]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('204', '8', '205', '205', NULL, NULL, NULL, NULL, '2026-03-31 12:26:59', '2026-03-31 12:35:54', '[[0,0],[26,0],[26,17],[21,17],[21,22],[10,22],[10,25],[0,25]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('205', '8', '202', '202', NULL, NULL, NULL, NULL, '2026-03-31 12:28:51', '2026-03-31 12:32:49', '[[58,0],[90,0],[90,21],[74,21],[74,17],[58,17]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('206', '8', 'Storage 22', 'S-22', NULL, NULL, NULL, NULL, '2026-03-31 12:30:54', '2026-03-31 18:52:27', '[[31,21],[41,21],[41,25],[31,25]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('207', '8', 'Mech 20', 'M-20', NULL, NULL, NULL, NULL, '2026-03-31 12:31:30', '2026-03-31 17:06:32', '[[41,21],[46,21],[46,25],[41,25]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('208', '8', 'Stair 1 U', 'S1U', NULL, NULL, NULL, NULL, '2026-03-31 12:32:10', '2026-03-31 17:06:31', '[[51,29],[55,29],[55,37],[51,37]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('209', '8', 'Stair 2 U', 'S2U', NULL, NULL, NULL, NULL, '2026-03-31 12:33:13', '2026-03-31 17:06:32', '[[10,22],[21,22],[21,25],[10,25]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('210', '8', 'Corridor B', 'C-B', NULL, NULL, NULL, NULL, '2026-03-31 12:35:16', '2026-03-31 17:06:32', '[[21,17],[74,17],[74,21],[90,21],[90,25],[55,25],[55,29],[51,29],[51,25],[46,25],[46,21],[31,21],[31,25],[21,25]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('211', '8', '201', '201', NULL, NULL, NULL, NULL, '2026-03-31 12:37:33', '2026-03-31 12:41:04', '[[55,25],[87,25],[87,41],[55,41],[51,41],[51,37],[55,37]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('212', '8', 'S-20', NULL, NULL, NULL, NULL, NULL, '2026-03-31 12:38:43', '2026-03-31 18:52:27', '[[32,34],[51,34],[51,45],[32,45]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('213', '8', 'Storage 21', 'S-21', NULL, NULL, NULL, NULL, '2026-03-31 12:40:40', '2026-03-31 18:52:27', '[[32,45],[51,45],[51,65],[32,65]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('214', '8', 'Storage 15', 'S1', NULL, NULL, NULL, NULL, '2026-03-31 12:41:56', '2026-03-31 18:52:27', '[[12,111],[22,111],[22,121],[12,121]]', '0', '1', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('215', '2', 'Corridor D', 'C-D', NULL, NULL, NULL, NULL, '2026-03-31 16:53:13', '2026-03-31 17:05:50', '[[58,0],[68,0],[68,86],[62,86],[62,57],[58,57]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('216', '2', 'Corridor E', NULL, NULL, NULL, NULL, NULL, '2026-03-31 16:54:24', '2026-03-31 17:05:50', '[[68,86],[122,86],[154,54],[154,0],[151,0],[151,-4],[160,-4],[160,50],[172,50],[172,56],[167,56],[158,65],[157,64],[153,64],[132,85],[132,89],[128,93],[68,93]]', '0', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('217', '7', 'Stage', 'S', NULL, NULL, NULL, NULL, '2026-04-03 12:34:06', '2026-04-03 12:34:19', '[[12,38],[51,38],[51,50],[12,50]]', '1', '0', '0', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('229', '1', 'Sanctuary', 'SANC', NULL, '0', NULL, NULL, '2026-04-04 17:42:59', '2026-04-04 17:42:59', '[[68,50],[74,30],[98,6],[120,0],[154,0],[154,54],[122,86],[68,86]]', '1', '0', '1', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('230', '1', 'Gym', 'GYM', NULL, '0', NULL, NULL, '2026-04-04 17:43:07', '2026-04-04 17:43:07', '[[0,0],[58,0],[62,39],[62,88],[40,88],[0,80]]', '1', '0', '1', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('231', '1', 'Lobby', 'LOBB', NULL, '0', NULL, NULL, '2026-04-04 17:43:18', '2026-04-04 17:43:18', '[[30,-17],[71,-17],[75,-8],[75,0],[30,0]]', '1', '0', '1', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('232', '1', 'Children\'s Lobby', 'CL', NULL, '0', NULL, NULL, '2026-04-04 17:44:01', '2026-04-04 17:44:01', '[[122,86],[146,71],[155,68],[165,72],[179,80],[179,90],[157,112],[147,112],[128,100]]', '1', '0', '1', NULL);
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('233', '1', 'Office Downstairs', 'OD', NULL, '0', NULL, NULL, '2026-04-04 17:44:28', '2026-04-04 17:44:28', '[[71,-17],[139,-17],[139,0],[75,0],[71,-8]]', '1', '0', '1', '2');
INSERT INTO `rooms` (`id`, `floor_id`, `name`, `abbreviation`, `room_number`, `capacity`, `description`, `default_setup`, `created_at`, `updated_at`, `map_points`, `is_reservable`, `is_storage`, `is_virtual`, `h_link_combination_id`) VALUES ('234', '2', 'Office Upstairs', 'OU', NULL, '0', NULL, NULL, '2026-04-04 17:45:18', '2026-04-04 17:45:18', '[[71,-17],[160,-17],[160,-4],[151,0],[75,0],[71,-8]]', '1', '0', '1', '3');
...
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('16', 'Kevin Gunn', 'Facilities Manager', 'k.gunn@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', '965555d0b240dea4f0d6255f3128ce27693b4a3f3893d7c8255e6b9c311e601f', '2026-04-05 00:15:34', 'admin', '1', '2026-03-25 21:03:26', '2026-04-04 14:15:34');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('17', 'Enas Blanchard', 'Office Manager', 'e.blanchard@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'scheduler', '1', '2026-03-25 21:03:26', '2026-03-25 21:53:55');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('18', 'Ryan Rough', 'Custodian', 'ryanruff38@gmail.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'custodial', '1', '2026-03-25 21:03:26', '2026-04-04 19:15:48');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('20', 'Kyle Bostock', 'Lead Pastor', 'k.bostock@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('21', 'Eris Pappas', 'Executive Pastor', 'e.pappas@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('22', 'Mark Hammer', 'Executive Pastor', 'm.hammer@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('23', 'Chad Morrison', 'Associate Pastor — Youth', 'c.morrison@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('24', 'Nate Lacy', 'Associate Pastor — Family', 'n.lacy@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('25', 'Eric Thompson', 'Associate Pastor — Connection', 'e.thompson@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('26', 'Will Shupp', 'Associate Pastor', 'w.shupp@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('27', 'Holly Curto', 'Receptionist', 'h.curto@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('28', 'Kathy Hellman', 'Bookkeeper', 'k.hellman@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('29', 'Kristine Oliver', 'Worship Director', 'k.oliver@northsummit.com', '$2y$10$B6XIhJx.GNAmS2GXdNXlCu4mWt8my7/lKNU46sFWwi3X5ZQPCS5hO', NULL, NULL, 'staff', '1', '2026-03-25 21:03:26', '2026-03-25 21:03:26');
INSERT INTO `users` (`id`, `name`, `title`, `email`, `password`, `reset_token`, `reset_token_expires`, `role`, `is_active`, `created_at`, `updated_at`) VALUES ('30', 'Josh Wallis', 'Janitor', 'joshwallis2@gmail.com', '$2y$10$UwayChlTul8hJmlXKU.dq.vTYxmph9699wxYtB0zYnYkB0MelsxXK', NULL, NULL, 'custodial', '1', '2026-04-01 19:07:23', '2026-04-04 19:17:53');
