...
<div class="max-w-2xl mx-auto p-8">
    <h1 class="text-xl font-bold mb-4">Migration: Task Rooms</h1>
    <p class="text-gray-600 mb-4">This migration will create:</p>
    <ul class="list-disc ml-6 mb-6 text-sm text-gray-700 space-y-1">
        <li><strong>task_rooms</strong> — links individual tasks to rooms</li>
    </ul>
    <form method="POST">
