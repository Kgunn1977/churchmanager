...
<div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <?php else: ?>
        ...
        <div class="mt-4">
            <a href="/pages/scheduling.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg px-4 py-2 text-sm transition inline-block">Go to Scheduling</a>
        </div>
    <?php endif; ?>
</div>
</body>
